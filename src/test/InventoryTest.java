...
public class InventoryTest {
    ...
    public void setUp2() {
        ...
        productsList.add(new Product("Crema", "Para caras limpias", 15000, 10, 8));
    ...
    public void addProductTest(){
        setUp1();
        inventory.addProduct(new Product ("Jabon", "Para pieles sedosas", 100, 10, 8));
        inventory.addProduct(new Product ("Shampoo", "Para cabellos sedosos", 500, 10, 8));
        inventory.addProduct(new Product ("Mascarilla", "Para caras sedosas", 510, 10, 8));
        ...
        String msg = inventory.addProduct(new Product ("Mascarilla", "Para caras sedosas", 510, 10, 8));
